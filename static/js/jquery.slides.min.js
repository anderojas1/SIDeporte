...
(function slider(){
	(function(e,t,n){
		...
		r.prototype.update=function(){
			...
			r=t.width();
			n=this.options.height/this.options.width*0.75*r;
		...
		r.prototype._touchstart=function(t){
			...
			n=e(this.element);
			this.data=e.data(this);
			r=t.originalEvent.touches[0];this._setuptouch();
		...
		r.prototype.play=function(t){
			...
			if(!this.data.playInterval){
				if(t){
					r=this.data.current;this.data.direction="next";
					this.options.play.effect==="fade"?this._fade():this._slide()
				}
				e.data(this,"playInterval",setInterval(function(){
					r=s.data.current;s.data.direction="next";
		...
		r.prototype._slide=function(t){var n,r,i,s,o,u,a,f,l,c,h=this;n=e(this.element);
			this.data=e.data(this);
		...
		r.prototype._fade=function(t){
			...
			if(!this.data.animating&&t!==this.data.current+1){
				...
				i===-1&&(i=this.data.total-1);i===this.data.total&&(i=0);this._setActive(i);
				s=e(".slidesjs-control",n);
