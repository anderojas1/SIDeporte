...
from .views import DetallesNoticia, BuscarNoticias, RegistrarNoticia, BorrarNoticia, EditarNoticia
...
urlpatterns =  patterns ('',
    ...
    url(r'^(?P<id_noticias>\d+)/update$', EditarNoticia.as_view(), name='editar_noticia'),
)